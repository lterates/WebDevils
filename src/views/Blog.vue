            ...
            <b-container fluid>
                <b-row fluid style="margin-top: 10vh" class="px-5">
                    <b-col >
                        ...
                        <p> When it comes to standing out in any marketplace, even individuals need to figure out how to successfully strut their stuff. </p>
                    </b-col>
                    <b-col class="px-5">
                        <b-img src="../assets/blog1.jpg" alt="Self Advertising" fluid rounded/>
                    </b-col>
                </b-row>
                ...
                <b-row style="margin-top: 15vh" class="px-5">
                    <b-col class="ml-5">
                        ...
                        <p>Can’t believe it’s already time to share our next season’s blog post idea list! Summer is always tough in blogging because who doesn’t want to 
                            ...
                            <p>4. Attend an outdoor show or event and write a review or recap</p>
